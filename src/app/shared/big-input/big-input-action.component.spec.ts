...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<saeed-big-input-action></saeed-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<saeed-big-input-action [disabled]="true"></saeed-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if icon property is set', () => {
    const template = `<saeed-big-input-action [icon]="'delete'"></saeed-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<saeed-big-input-action [label]="'delete'"></saeed-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<saeed-big-input-action (action)="actionHandler()"></saeed-big-input-action>`;
    fixture = createHostComponent(template);
